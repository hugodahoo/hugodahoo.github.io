window.projects = [
  {
    "id": "translation-stream-al-ain",
    "title": "TRANSLATION STREAM (MANAR AL AIN)",
    "year": "2025",
    "client": "Rafael Lozano-Hemmer / Manar Abu Dhabi, Al Ain",
    "role": "Lead Creative Technologist",
    "technologies": "TouchDesigner, Projection, Camera tracking, IR sensors",
    "description": "Interactive projected poetry translating between Arabic and English in real time",
    "impact": null,
    "impact-title": "TRANSLATION STREAM \u2014 Projected poetry morphing between languages as visitors walk an oasis trail",
    "media": [
    ...
    "cover": null,
    "hasMedia": true,
    "fullDescription": "Translation Stream is an interactive light art installation presented at the Al Qattara Oasis Trail in Al Ain as part of Manar Abu Dhabi 2025 (November 1, 2025 \u2013 January 4, 2026). The work features poems by contemporary Emirati poets Nujoom Alghanem, Khalid Albudoor, and Adel Khozam presented as a slow stream of projected letters across a trail.\nAs visitors walk through the installation, motion sensors automatically detect their presence and translate the poems between English and Arabic in real time. The flow of letters is controlled by fluid dynamic equations to ensure each interaction creates a unique pattern, transforming poetry \u2014 the most challenging form of writing to translate \u2014 into an embodied path where languages seamlessly morph between one another.\nThis is an adaptation of the Translation Stream work first presented at Translation Island (Abu Dhabi, 2023-2024), now relocated to the desert oasis landscape of Al Ain for the second edition of the MANAR festival.\nTechnical details and implementation\n- Video projectors with short throw lenses in outdoor enclosures\n- Camera and IR light tracking system for visitor detection\n- TouchDesigner-based fluid dynamics engine controlling letter flow and translation behavior\n- Media server and tracking computer with loudspeakers for spatial audio\nChallenges and solutions\n- Desert environment required sealed outdoor enclosures and dust management\n- Adapting the work from its original coastal context to an oasis trail setting\n- Ensuring Arabic/English typographic flow maintains legibility during transitions\n- Night-time operation in a natural landscape with minimal ambient infrastructure\nImpact and results\n- Part of the expanded Manar Abu Dhabi 2025, which grew from coastline to desert locations\n- Poetic engagement with Emirati literary culture and bilingual identity\n- Successfully adapted a proven work to a new site-specific context\nProcess and methodology\n- Site adaptation from Translation Island's coastal setting to Al Ain's oasis trail\n- Collaboration with Emirati poets for content curation\n- On-site calibration for projection geometry and tracking coverage along the trail\n---",
    "videoEmbed": "https://vimeo.com/908314402"
  },
  {
    "id": "undercurrents",
    "title": "UNDERCURRENTS",
    ...
    "technologies": "LED, Audio, Intercom systems",
    "description": "Interactive LED and voice installation in a 1926 underground cistern",
    "impact": null,
    "impact-title": "UNDERCURRENTS \u2014 Encoding voice into light across a mile-long network in a subterranean reservoir",
    "media": [
      "https://buffalobayou.org/2026-undercurrents/"
    ],
    "instagram": [
      "https://www.instagram.com/lozanohemmer/"
    ],
    "cover": null,
    "hasMedia": true,
    "fullDescription": "Undercurrents is an interactive installation by Rafael Lozano-Hemmer at the Buffalo Bayou Park Cistern in Houston, running from April 24, 2026 through January 24, 2027. The work features a mile-long network of white LED lights suspended just above the water line, winding through the Cistern\u2019s 221 concrete columns. Visitors record brief voice messages at intercoms positioned along the perimeter; these recordings are encoded into light patterns that travel through the LED network, sometimes returning to the sender or routing to another microphone like a message in a bottle.\nThe installation combines visitor recordings with poetry from five Houston writers \u2014 Aris Kian, Jennifer Teets, Martha Serpas, Nick Flynn, and Roberto Tejada \u2014 creating a choral work where live voice messages mix with curated text. The Cistern\u2019s unique 17-second echo and acoustic properties enhance the experience.\nThe piece coincides with the Cistern\u2019s 100th anniversary (built in 1926) and marks its 10-year milestone as a public art venue. It is the Cistern\u2019s first truly interactive installation.\nTechnical details and implementation\n- Mile-long LED light network suspended above mirrored water surface between 221 columns\n- Intercom stations for voice capture with real-time encoding into light pulse patterns\n- Audio routing system distributing messages across the network with variable propagation paths\n- Integration of pre-recorded poetry with live visitor input\nChallenges and solutions\n- 17-second natural echo required careful audio processing to maintain intelligibility\n- Routing voice-to-light encoding across the full network demanded precise timing and synchronization\n- Humid underground environment required weatherproofing and corrosion-resistant hardware\n- Balancing ambient reflections on water with LED visibility\nImpact and results\n- First interactive artwork at the Buffalo Bayou Park Cistern\n- Transforms a civic infrastructure landmark into a participatory communication instrument\n- Featured in Houston Public Media, Axios, and Buffalo Bayou Partnership press\nProcess and methodology\n- Site-specific design responding to the Cistern\u2019s unique column grid and acoustic properties\n- Collaboration with local poets for curated text content\n- On-site calibration of LED brightness, audio levels, and routing algorithms\n---",
    "videoEmbed": "https://vimeo.com/1187481619/148982a75d"
  },
  {
    "id": "jardin-inconcluso",
    "title": "JARD\u00cdN INCONCLUSO",
    "year": "2026",
    "client": "Rafael Lozano-Hemmer / Museo de Arte Moderno, Mexico City",
    "role": "Creative Technologist",
    "technologies": "Multiple sensing systems, projection, spatial audio, LED",
    "description": "Major nocturnal interactive exhibition spanning 9 installations across the museum",
    "impact": null,
    "impact-title": "JARD\u00cdN INCONCLUSO \u2014 Nine interactive installations activating a national museum after dark",
    "media": [
      "https://www.lozano-hemmer.com/exhibitions/rafael_lozano-hemmer_jardin_inconcluso_mexico_city_2026.php"
    ],
    "instagram": [
      "https://www.instagram.com/lozanohemmer/"
    ],
    "cover": null,
    "hasMedia": true,
    "fullDescription": "Jard\u00edn Inconcluso (Unfinished Garden) is a major nocturnal interactive exhibition by Rafael Lozano-Hemmer at the Museo de Arte Moderno in Mexico City, running from February 11 to April 25, 2026. The exhibition comprises nine large-scale interactive installations spanning roughly one kilometer through the sculpture garden, main atrium, and Sala Gamboa.\nThe works respond in real time to visitor presence, voice, heartbeat, body heat, and movement. Notable installations include a rotating beacon modulated by cosmic radiation, a path of voices that configures and dissolves through interaction with National Phonotheca archives, a sonic installation with three thousand speakers, a landscape of lights activated by heartbeats, and indigenous language poems flowing in turbulent digital streams.\nThe exhibition activates after dusk (7-10pm, Wednesday through Saturday) and emphasizes the concept of incompleteness \u2014 public participation is essential to the artworks\u2019 existence. It marks Lozano-Hemmer\u2019s return to Mexican museums after a 10-year absence.\nTechnical details and implementation\n- Nine distinct interactive systems deployed across indoor and outdoor spaces spanning ~1km\n- Multiple sensing modalities: presence detection, voice capture, heartbeat sensors, thermal imaging, motion tracking\n- Spatial audio across thousands of channels distributed through the sculpture garden\n- Cosmic radiation sensors modulating light beacon behavior\n- Integration with National Phonotheca audio archives\nChallenges and solutions\n- Coordinating nine technically distinct installations across varied indoor/outdoor environments\n- Operating reliably in an outdoor sculpture garden with variable weather and ambient light\n- Managing visitor flow across a kilometer-long nocturnal path with safety considerations\n- Interfacing with archival audio systems and indigenous language content\nImpact and results\n- Major institutional exhibition at one of Latin America\u2019s most important modern art museums\n- Lozano-Hemmer\u2019s return to Mexico after 10 years, covered by national press and government cultural ministry\n- Nocturnal format creates a unique visitor experience distinct from typical museum hours\n- Exhibition officially endorsed by Mexico\u2019s Secretar\u00eda de Cultura\nProcess and methodology\n- Site-specific planning across multiple architectural zones (garden, atrium, gallery)\n- Coordination with museum operations for nocturnal access and visitor safety protocols\n- Integration of culturally significant content (indigenous languages, national archives)\n- Phased installation across the full site with per-zone commissioning\n---",
    "videoEmbed": "https://vimeo.com/1174843461"
  },
  {
    ...
    "role": "Creative Technologist",
    "technologies": "Thermal cameras, GPU particle systems, projection",
    "description": "Interactive thermal imaging installation in a historic 1893 fronton",
    "impact": null,
    "impact-title": "DERIVA T\u00c9RMICA (BETI JAI) \u2014 Thermal drift reimagined in an 800m\u00b2 heritage pelota court",
    "media": [
      "https://luzmadridfestival.com/en/installations/deriva-termica-thermal-drift/"
    ],
    "instagram": [
      "https://www.instagram.com/lozanohemmer/"
    ],
    "cover": null,
    "hasMedia": true,
    "fullDescription": "Deriva T\u00e9rmica (Thermal Drift) was presented at the Front\u00f3n Beti Jai in Madrid as part of LuzMadrid 2026, the city\u2019s International Light Festival, running March 12-14, 2026.\nThe interactive artwork visualizes the dispersion of body heat as generative color emissions that flow away from participants. Using thermal imaging cameras and computer-generated particle systems, it reveals the porous boundary between body and environment. The piece repurposes surveillance technology typically associated with police or military contexts, transforming it into a participatory cultural experience.\nThe venue \u2014 Beti Jai \u2014 is Madrid\u2019s last surviving 19th-century Basque pelota fronton. Designed by Joaqu\u00edn Rucoba and opened in 1894, it combines Neo-Mud\u00e9jar brick with industrial iron structures across 800 square meters. Declared a Bien de Inter\u00e9s Cultural (Site of Cultural Interest) in 2011, its recent renovation won the 2025 National Award for Restoration and Conservation of Cultural Assets.\nTechnical details and implementation\n- Thermal imaging cameras capturing body heat in the 800m\u00b2 fronton space\n- GPU-accelerated particle systems generating real-time heat dispersion visualizations\n- Large-scale projection calibrated to the venue\u2019s unique Neo-Mud\u00e9jar architecture\n- Adaptive calibration for the specific thermal characteristics of the heritage building\nChallenges and solutions\n- Heritage building constraints required non-invasive installation methods\n- Large open volume (800m\u00b2) demanded wide-coverage thermal sensing and projection\n- Three-day festival format required rapid install/strike with zero damage to protected surfaces\n- Variable crowd density required adaptive thermal background subtraction\nImpact and results\n- Featured as flagship installation of LuzMadrid 2026 festival\n- Activated a recently restored national heritage monument for contemporary art\n- Free admission drew large public audiences over three evenings\n- Press coverage in El Diario de Madrid, Max Estrella gallery, and festival communications\nProcess and methodology\n- Site-specific adaptation of Thermal Drift for the fronton\u2019s unique dimensions and architecture\n- Pre-event thermal mapping of the space to calibrate background subtraction\n- Rapid deployment protocol for festival timeline constraints\n- Coordination with heritage authorities regarding installation methods\n---",
    "videoEmbed": "https://vimeo.com/1177840069"
  },
  {
  ...
  },
  {
    ...
    "videoEmbed": "https://vimeo.com/1067505877"
  },
  {
    "id": "collider",
    "title": "COLLIDER",
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Generative software, Fluid dynamics",
    "description": "Generative animation rendering 17th-century poetry as a fluid vortex of words",
    "impact": null,
    ...
    "videoEmbed": "https://vimeo.com/918355658?share=copy"
  },
  {
    ...
    "client": "Rafael Lozano-Hemmer / ABU DHABI",
    "role": "Lead Creative Technologist",
    "technologies": "Projection, Camera tracking, Depth sensors",
    "description": "2 km interactive night trail with AI, sensors, and projection across desert dunes",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Projection, Interactive sensors, Spatial audio",
    "description": "Immersive exhibition converting voice and breath into volumetric projections",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Audio-reactive systems, LED, Live performance",
    "description": "Live percussion performance mapped to 3,000 synchronized light bulbs",
    "impact": null,
    ...
    "videoEmbed": "https://vimeo.com/1029304518"
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "AI computer vision, LED display",
    "description": "Group exhibition featuring AI computer vision and generative LED artwork",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Multiple interactive systems, Exhibition design",
    "description": "Survey exhibition of Mexican technological culture with interactive systems",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Biometric sensors, Projection, Interactive systems",
    "description": "Seven interactive installations driven by pulse, voice, and body heat",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Thermal cameras, GPU particle systems, Projection",
    "description": "Thermal cameras transforming body heat into evolving particle landscapes",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Neon, Generative text",
    "description": "Neon and generative text installation exploring language and misunderstanding",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Projection, Interactive sensors, Water simulation",
    "description": "Fluid simulations and projection mapping shaping water-centric narratives",
    "impact": null,
  ...
  },
  {
    ...
    "videoEmbed": "https://vimeo.com/932612162"
  },
  {
    "id": "hormonium",
    "title": "HORMONIUM",
    ...
    "role": "Lead Creative Technologist",
    "technologies": "Generative software, LED display",
    "description": "Generative ocean waves releasing hormone text particles over a 90-year cycle",
    "impact": null,
  ...
  },
  {
    ...
    "technologies": "AR, Live broadcast, Real-time rendering",
    "description": "Live augmented reality broadcast for League of Legends esports",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Technologist",
    "technologies": "Projection mapping, Depth sensors, TouchDesigner",
    "description": "Projection-mapped terrain reacting to proximity, touch, and regeneration",
    "impact": null,
    ...
    "videoEmbed": "https://vimeo.com/911080425"
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Motion tracking, AI",
    "description": "AI art experience translating visitor motion into generative imagery",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive web, Real-time rendering",
    "description": "Interactive web experience for album launch with real-time visuals",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Notch, disguise, XR, LED walls",
    "description": "Adaptive arena visuals with Notch and disguise real-time pipeline",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "3D LiDAR, IR tracking, Projection mapping, TouchDesigner",
    "description": "Ultra-low-latency ball and player tracking with real-time projection",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Fountains, Show control",
    "description": "Permanent multimedia nighttime shows with projection, fountains, and fire",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Real-time visuals, LED, Media servers",
    "description": "Hybrid precomp and real-time visual system tuned per venue",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Real-time visuals, LED, Media servers",
    "description": "High-impact visual content for global arena tour",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive installation, Video, Sculpture",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive installation, Projection",
    "description": "Generative content for corporate architectural media installation",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, LED, Live visuals",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "LiDAR, TouchDesigner, Interactive projection",
    "description": "Permanent interactive wayfinding wall with LiDAR and custom CMS",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Interactive",
    "description": "Laser and light installation for gallery vernissage event",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Interactive lighting",
    "description": "Crowd-interactive choral light and sound installation for winter festival",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Real-time visuals, VJing",
    "description": "Live laser and visual performance for music video production",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Real-time visuals, LED",
    "description": "Set design and real-time visuals for hip-hop music video",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive installation, Projection",
    "description": "Laser volumes mapped to water, smoke, and glass for tactile light geometry",
    "impact": null,
    ...
    "videoEmbed": "https://www.youtube.com/watch?v=deJFh_Qh0JQ"
  },
  {
    "id": "d-s-destiny",
    "hidden": true,
    ...
    "role": "Creative Developer",
    "technologies": "Real-time visuals, Interactive projection",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Interactive",
    "description": "Live generative visuals for fashion and design festival stage",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Interactive lighting",
    "description": "Real-time visual overlays for ultra-wide urban projection canvas",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "LED displays, Real-time data, Custom software",
    "description": "LED creatures animated by live market data with emotional interfaces",
    "impact": null,
  ...
  },
  {
    ...
    "client": "Moment Factory / NEW YORK",
    "role": "Creative Developer",
    "technologies": "Multitouch, Interactive audio-visual, TouchDesigner",
    ...
    "videoEmbed": "https://vimeo.com/256990589"
  },
  {
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Body scanning, Spatial audio",
  ...
  },
  {
    ...
    "client": "Moment Factory / MONTRÉAL",
    "role": "Creative Developer",
    "technologies": "Projection mapping, Media servers",
    "description": "Real-time visual choreography with dancers and symphonic orchestra",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "R&D, Interactive systems, Projection",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive projection, Real-time visuals",
    "description": "Real-time generative visuals with live dancers for corporate keynote",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "3D point cloud, Interactive projection, TouchDesigner",
    "description": "Multi-room interactive exhibition exploring Japanese food culture",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Interactive installation, Projection",
    "description": "Stretch-fabric haptic installation generating audio-visual feedback",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Depth sensors, Holographic projection, Outdoor installation",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Spatial audio",
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "Projection mapping, Live broadcast",
    "description": "Live VJ performance for awards ceremony broadcast",
    "impact": null,
  ...
  },
  {
    ...
    "role": "Creative Developer",
    "technologies": "LiDAR, TouchDesigner, Interactive projection",
    "description": "Permanent interactive LiDAR wall revealing park trails and nature stories",
    "impact": null,
