...
(function () {
  ...
  var UI = {
    ...
    'about.bio.p2': {
      en: 'Since 2021, Lead Creative Developer at Atelier Lozano-Hemmer, where he researches, prototypes, programs, and installs interactive artworks exhibited across four continents and collected by major institutions. Recent projects include Abu Dhabi\'s MANAR festival, Madrid\'s LuzMadrid, Crystal Bridges Museum, and the Museo de Arte Moderno de Mexico. Previously at Moment Factory, where he built visual systems for international tours including Arcade Fire (Infinite Content Tour, Frame Award, Set Design of the Year), Red Hot Chili Peppers (Getaway Tour), and Billie Eilish, alongside permanent installations like Nova Lumina and Kontinuum.',
      fr: 'Depuis 2021, Lead Creative Developer à l\'Atelier Lozano-Hemmer, où il conçoit, prototype, programme et installe des œuvres interactives exposées sur quatre continents et collectionnées par des institutions majeures. Parmi les projets récents : le festival MANAR d\'Abu Dhabi, LuzMadrid, le Crystal Bridges Museum et le Museo de Arte Moderno de Mexico. Auparavant chez Moment Factory, il a développé les systèmes visuels de tournées internationales incluant Arcade Fire (Infinite Content Tour, Frame Award, Set Design of the Year), Red Hot Chili Peppers (Getaway Tour) et Billie Eilish, ainsi que des installations permanentes comme Nova Lumina et Kontinuum.'
    },
    'about.bio.p3': {
